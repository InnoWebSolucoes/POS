  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Fixed hues for the menu tiles, mirroring the reference POS layout.
        tile: {
          coral: '#EF5B5B',
          orange: '#F2814B',
          maroon: '#A8213C',
      ...
      fontSize: {
        // KDS needs to be readable from across a kitchen.
      ...
      animation: {
        ...
        'scan-flash': 'scan-flash 0.5s ease-out',
        'ticket-pulse': 'ticket-pulse 1.4s ease-in-out infinite',
      },
    },
  },
